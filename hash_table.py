...
def main():
	...
	print("************** Insert **************")
	show1 = ["Raymond Holt", "Jake Peralta", "Amy Santiago", "Terry Jeffords", "Charles Boyle", "Rosa Diaz", "Gina Linetti", "Cheddar the Dog"]
	ht.insert("Brooklyn 99", show1)
	show2 = ["Michael Scott", "Jim Halpert", "Pam Beasly", "Creed", "Andy Bernard", "Kevin Malone", "Dwight Schrute", "Angela Martin", "Phyllis Vance", "Stanley Hudson"]
	ht.insert("The Office", show2)
	print("DONE !")
	print("************** Find **************")
	names = None
	names = ht.find("Brooklyn 99")
	print(names)
	print("--------------------------------------------")
	names = None
	names = ht.find("The Office")
	print(names)

	print("************** Remove **************")
	ht.remove("The Office")
	names = ht.find("The Office")
	print(names)
